import {
  ...
  n as blue,
  o as decryptString,
  p as createSlotValueFromString,
  r as renderTemplate,
  f as renderComponent,
  D as DEFAULT_404_COMPONENT,
  q as renderSlotToString,
  t as renderJSX,
  u as chunkToString,
  v as isRenderInstruction,
  w as clientLocalsSymbol,
  x as clientAddressSymbol$1,
  A as ASTRO_VERSION,
  z as responseSentSymbol$1,
  B as renderPage,
  C as REWRITE_DIRECTIVE_HEADER_KEY,
  E as REWRITE_DIRECTIVE_HEADER_VALUE,
  F as renderEndpoint,
  G as REROUTABLE_STATUS_CODES,
  H as commonjsGlobal,
} from "./astro/server_BKMyejKU.mjs";
import {
  A as AstroError,
...
} from "./astro/assets-service_DQyTf1uX.mjs";
import {
...
} from "./astro-designed-error-pages_z2feE0sM.mjs";
  ...
  async getMiddleware() {
    if (this.resolvedMiddleware) {
      ...
      if (this.manifest.checkOrigin) {
        this.resolvedMiddleware = sequence(
