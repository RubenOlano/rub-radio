...
import {
  ...
  g as renderHead,
  h as renderSlot,
  i as renderTransition,
} from "../chunks/astro/server_D98Bh4Pm.mjs";
...
const $$ViewTransitions = createComponent(
  ...
  "/Users/ruben/rub-radio/node_modules/.pnpm/astro@4.15.9_rollup@4.22.5_typescript@5.6.2/node_modules/astro/components/ViewTransitions.astro",
  void 0,
);
    ...
    return renderTemplate`${renderComponent(
      ...
      {},
      {
        default: (
          ...
          "class:list",
        )}${addAttribute(latestPlaying.art, "src")}${addAttribute(latestPlaying.song, "alt")}${addAttribute(renderTransition($$result2, "bwabbhoa", "", "art"), "data-astro-transition-scope")}> <div class="flex flex-col space-y-2"> <h1 class="text-3xl md:text-4xl lg:text-6xl font-bold"${addAttribute(renderTransition($$result2, "pduda75b", "", "title"), "data-astro-transition-scope")}>
