/* empty css                                 */
import { c as createComponent, r as renderTemplate, m as maybeRenderHead, a as createAstro, b as addAttribute, f as renderComponent, g as renderHead, h as renderSlot, i as renderTransition } from '../chunks/astro/server_D98Bh4Pm.mjs';
...
}, "/Users/ruben/rub-radio/src/icons/HomeIcon.astro", void 0);
...
const client = postgres("postgresql://postgres.adzltwzdigjfjrylqvto:miQ59eWsHjVwNvS9@aws-0-us-east-1.pooler.supabase.com:6543/postgres", { prepare: false });
...
const $$PlaylistEntry = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$4, $$props, $$slots);
  Astro2.self = $$PlaylistEntry;
  const { idx } = Astro2.props;
  const [song] = await db.select().from(listeningHistory).orderBy(desc(listeningHistory.listenedAt)).offset(PAGE_SIZE * idx).limit(1);
  if (!song) throw new Error("No song found");
  return renderTemplate`${maybeRenderHead()}<a class="flex items-center space-x-4 p-3 rounded-md hover:bg-gray-800 transition-colors ease-in-out duration-300"${addAttribute(`/?playlist=${idx + 1}`, "href")}> <img class="w-12 h-12 rounded-md shadow-md transition-transform transform hover:scale-105"${addAttribute(song.art, "src")}${addAttribute(song.song, "alt")}> <div class="flex flex-col justify-center"> <span class="text-sm font-semibold text-gray-400 hover:text-white truncate transition-colors ease-in-out duration-300">
Listening - ${idx + 1} </span> </div> </a>`;
}, "/Users/ruben/rub-radio/src/components/PlaylistEntry.astro", void 0);
...
const $$Sidebar = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="hidden md:flex flex-col text-gray-500 bg-black h-screen w-60 p-4 border-r border-gray-900 overflow-y-scroll scrollbar-hide"> <div class="space-y-6"> <a href="/" class="flex items-center space-x-4 p-3 rounded-md hover:bg-gray-800 transition-colors ease-in-out duration-300"> ${renderComponent($$result, "HomeIcon", $$HomeIcon, {})} <span class="text-sm font-semibold">Home</span> </a> <hr class="border-gray-700"> <div class="flex flex-col space-y-2"> <span class="text-xs text-gray-400 uppercase tracking-widest pl-3">
My History
...
}, "/Users/ruben/rub-radio/src/components/Sidebar.astro", void 0);
...
}, "/Users/ruben/rub-radio/node_modules/.pnpm/astro@4.15.9_rollup@4.22.5_typescript@5.6.2/node_modules/astro/components/ViewTransitions.astro", void 0);
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en"> <head><meta charset="UTF-8"><meta name="description" content="Astro description"><meta name="viewport" content="width=device-width"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><meta name="generator"${addAttribute(Astro2.generator, "content")}><title>${title}</title>${renderComponent($$result, "ViewTransitions", $$ViewTransitions, {})}${renderHead()}</head> <body class="bg-black h-screen overflow-hidden"> <div class="flex"> ${renderComponent($$result, "Sidebar", $$Sidebar, {})} ${renderSlot($$result, $$slots["default"])} </div> </body></html>`;
}, "/Users/ruben/rub-radio/src/layouts/Layout.astro", void 0);

const $$Astro$1 = createAstro();
const $$Song = createComponent(($$result, $$props, $$slots) => {
...
}, "/Users/ruben/rub-radio/src/components/Song.astro", void 0);
...
}, "/Users/ruben/rub-radio/src/icons/ClockIcon.astro", void 0);
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const [latestPlaying, ...rest] = await db.select().from(listeningHistory).orderBy(desc(listeningHistory.listenedAt)).offset(PAGE_SIZE * (page - 1)).limit(10);
  ...
  const timeElapsed_ms = Date.now() - new Date(latestPlaying.listenedAt).getTime();
  const song_length_ms = latestPlaying.length;
  const isPlaying = timeElapsed_ms < song_length_ms;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, {}, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="flex-grow text-white h-screen overflow-y-scroll scrollbar-hide"> <section${addAttribute(`flex items-end space-x-7 bg-gradient-to-b to-black ${color} h-80 text-white p-8`, "class")}> <img${addAttribute([
    "rounded-full w-32 h-32 md:w-48 md:h-48 shadow-lg",
    { "animate-spin-slow": isPlaying }
  ], "class:list")}${addAttribute(latestPlaying.art, "src")}${addAttribute(latestPlaying.song, "alt")}${addAttribute(renderTransition($$result2, "bwabbhoa", "", "art"), "data-astro-transition-scope")}> <div class="flex flex-col space-y-2"> <h1 class="text-3xl md:text-4xl lg:text-6xl font-bold"${addAttribute(renderTransition($$result2, "pduda75b", "", "title"), "data-astro-transition-scope")}>
Rub's Listening - ${page} </h1> <h2 class="text-2xl md:text-3xl lg:text-5xl font-bold"${addAttribute(renderTransition($$result2, "ephrrych", "", "title-song"), "data-astro-transition-scope")}> ${latestPlaying.song} </h2> <p class="text-lg md:text-xl text-gray-300"${addAttribute(renderTransition($$result2, "ralnyjf7", "", "title-artist"), "data-astro-transition-scope")}>
...
}, "/Users/ruben/rub-radio/src/pages/index.astro", "self");
