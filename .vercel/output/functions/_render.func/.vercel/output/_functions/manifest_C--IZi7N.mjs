import { d as decodeKey } from "./chunks/astro/server_BKMyejKU.mjs";
import { N as NOOP_MIDDLEWARE_FN } from "./chunks/astro-designed-error-pages_z2feE0sM.mjs";
...
const manifest = deserializeManifest({
  ...
  routes: [
    ...
    },
    {
      ...
      links: [],
      scripts: [],
      styles: [{ type: "external", src: "/_astro/index.Dq8NBIE1.css" }],
      routeData: {
        route: "/",
        isIndex: true,
        type: "page",
  ...
  entryModules: {
    ...
    "\u0000@astrojs-manifest": "manifest_C--IZi7N.mjs",
    "astro:scripts/before-hydration.js": "",
  },
  inlinedScripts: [],
  assets: ["/_astro/index.Dq8NBIE1.css", "/favicon.svg"],
  buildFormat: "directory",
  checkOrigin: false,
  serverIslandNameMap: [],
  key: "0Uesnj52nVZapZCDKDlueS6Lzr8+GWEhvczrax1BxA8=",
